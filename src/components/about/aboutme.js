...
const Aboutme = () => (
    ...
    <div class="about__intro">
      ...
      <h5><strong>Technologies and Philosophy</strong></h5>
      <p>My expertise and interest lies in front-end technologies, including HTML/5, CSS/3, JavaScript (as well as frameworks like jQuery, VueJs, and Angular).</p>
      ...
      <h5><strong>Spare Time</strong></h5>
